...
import mobspy.units.handler as uh
...
def convert_parameters_for_COPASI(  # noqa: N802  # legacy DSL method name
    params: dict[str, Any],
...
def check_method_parameter(params: dict[str, Any]) -> None:
    ...
    valid_basiCO_deterministic = ["deterministic", "lsoda"]  # noqa: N806  # legacy name
    valid_basiCO_stochastic = [  # noqa: N806  # legacy DSL variable convention
        "hybrid",
        "hybridode45",
        "hybridlsoda",
        "tauleap",
