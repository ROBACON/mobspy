...
class _MsActiveProxy:
    ...
    def get(self, default: bool = False) -> bool:  # noqa: ARG002  # protocol arg
...
class Bool_Override:  # noqa: N801  # legacy DSL public API name
    """
...
class Specific_Species_Operator(Bool_Override):  # noqa: N801  # legacy API name
    """
