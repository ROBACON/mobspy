...
class __Operator_Base:  # noqa: N801  # legacy DSL public API name
...
class __Round_Robin_Base(__Operator_Base):  # noqa: N801  # legacy DSL public API name
...
class __RR_Default_Base(__Operator_Base):  # noqa: N801  # legacy DSL public API name
...
class __Set_Reversible_Rate:  # noqa: N801  # legacy DSL public API name
...
class __Reversible_Base:  # noqa: N801  # legacy DSL public API name
...
class _Set_Reaction_User_Base:  # noqa: N801  # legacy DSL public API name
...
class _Set_Reaction_Method:  # noqa: N801  # legacy DSL public API name
    ...
    def at(self, time: int | float) -> _Set_Reaction_Method:  # noqa: ARG002
        ...
        for spe_obj in self.reaction.reactants + self.reaction.products:
            spe_obj = spe_obj["object"]  # noqa: PLW2901  # intentional
