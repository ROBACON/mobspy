...
from mobspy.expressions.evaluation import (  # noqa: E402  # deferred import
    ExpressionDefiner as me_ExpressionDefiner,
)
from mobspy.expressions.evaluation import (  # noqa: E402  # deferred import
    QuantityConverter as me_QuantityConverter,
)
from mobspy.expressions.nodes import (  # noqa: E402  # deferred import after lazy setup
    ParamRefNode,
)


class Internal_Parameter_Constructor(me_ExpressionDefiner, me_QuantityConverter):  # noqa: N801  # legacy API name
    ...
    class _ParameterStackDescriptor:
        ...
        def __get__(
            ...
            return get_session().parameter_stack
    ...
    def unit_process(self, value: Quantity) -> tuple[float | int, Any]:
...
def ModelParameters(  # noqa: N802  # legacy DSL method name
    *args: Any,
    ...
    separated_line = code_line.split("=", maxsplit=1)[0].replace(" ", "")
