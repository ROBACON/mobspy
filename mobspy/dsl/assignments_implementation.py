...
if TYPE_CHECKING:
    from mobspy.dsl.reactions import Reacting_Species as _Reacting_Species
    from mobspy.dsl.species import Species as _Species
...
from mobspy.expressions.evaluation import MobsPyExpression as mbe_MobsPyExpression
from mobspy.types import AssignmentData


class Assignment_Operator:  # noqa: N801  # legacy DSL public API name
    ...
    def add(first: object, second: object) -> mbe_MobsPyExpression:
        ...
        return first + second  # type: ignore[no-any-return]  # dynamic dispatch
    ...
    def compile_assignments_for_sbml(
        ...
        for asg in unprocessed_asgns:  # noqa: PLC0206  # iterating dict keys directly
