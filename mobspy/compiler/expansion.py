...
def construct_order_structure(
    ...
    for species_object, species_string in zip(
        species_order_list, current_species_string_list, strict=True
    ):
        try:
