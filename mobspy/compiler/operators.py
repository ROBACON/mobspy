...
from mobspy.dsl.species_constructors import Zero
...
def new_reaction_with_new_characteristics(
    ...
    React: Any = Zero  # noqa: N806  # legacy DSL variable convention
    for reactant in r.reactants:
        ...
        React = React + rs  # noqa: N806  # legacy DSL variable convention

    # Build new products list
    Product: Any = Zero  # noqa: N806  # legacy DSL variable convention
    for product in r.products:
        ...
        Product = Product + ps  # noqa: N806  # legacy DSL variable convention
