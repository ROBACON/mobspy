...
objects, users can construct expression trees directly::
    ...
    from mobspy.expressions.rate_builder import RateExpression, species_ref, param_ref
...
class RateExpression:
    ...
    def _wrap(
        ...
        from mobspy.dsl.species import Species as _Species  # noqa: PLC0415
...
def param_ref(name: str) -> RateExpression:
    ...
    Examples:
        >>> from mobspy.expressions.rate_builder import param_ref
        >>> ref = param_ref("k1")
        >>> str(ref)
        'k1'
    """
