...
_QUANTITY_OPS: dict[str, Callable[..., Any]] = {
    ...
    "__radd__": Quantity.__radd__,  # type: ignore[misc]  # pint generic access
    "__sub__": Quantity.__sub__,
    "__rsub__": Quantity.__rsub__,
    "__mul__": Quantity.__mul__,
    "__rmul__": Quantity.__rmul__,  # type: ignore[misc]  # pint generic access
...
class ExpressionDefiner:
    ...
    def create_from_new_operation(  # noqa: PLR0913  # complex function signature
        self,
        other: Any,
        symbol: str,
        count_op: Any,
...
def _build_operation_node(  # noqa: PLR0913  # complex function signature
    self_obj: Any,
    other: Any,
    symbol: str,
    count_op: Any,
...
from mobspy.units.registry import (  # noqa: E402  # deferred import after lazy setup
    OverrideUnitRegistry as OverrideUnitRegistry,  # noqa: PLC0414
)
from mobspy.units.registry import u as u  # noqa: PLC0414, E402  # re-export
...
class QuantityConverter:
    ...
    def convert_received_unit(
        ...
        if model_context is None:
            from mobspy.expressions.context import (  # noqa: PLC0415  # circular import
        ...
        if not is_override:
            return copied_quantity  # type: ignore[no-any-return]
    ...
    @classmethod
    def _apply_dimension_replacements(  # noqa: PLR0913  # complex function signature
        cls,
        copied_quantity: Any,
        length_repl: str,
        time_repl: str,
...
class MobsPyExpression(Specific_Species_Operator, ExpressionDefiner):
    ...
    def _check_constant_expression_units(
        ...
        dimension: int,  # noqa: ARG002  # unused arg required by protocol
        _time_u: Any,
        _vol_u: Any,
    ) -> tuple[str, bool] | None:
        ...
        if (
            ...
            if self._unit_count_op.is_compatible_with(count_target):  # pyright: ignore[reportAttributeAccessIssue]  # pint method
                return operation, True
            if self._unit_conc_op.is_compatible_with(conc_target):  # pyright: ignore[reportAttributeAccessIssue]  # pint method
...
def _apply_legacy_variable_conversion(  # noqa: PLR0913  # complex function signature
